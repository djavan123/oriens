...
class ProjectRisk(Base):
    ...
    impact: Mapped[RiskLevel] = mapped_column(Enum(RiskLevel), default=RiskLevel.medium, nullable=False)
    probability: Mapped[RiskLevel] = mapped_column(Enum(RiskLevel), default=RiskLevel.medium, nullable=False)
